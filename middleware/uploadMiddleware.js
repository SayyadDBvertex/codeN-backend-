...
const fileFilter = (req, file, cb) => {
  const allowedMimeTypes = [
    'video/mp4', 'video/mpeg', 'video/ogg', 'video/webm', 'video/quicktime', // Videos
    'image/jpeg', 'image/png', 'image/jpg', 'image/webp',                   // Thumbnails
  ...
  if (allowedMimeTypes.includes(file.mimetype)) {
    ...
    cb(new Error('Invalid file type! Only Video, Images (JPG/PNG), and PDFs are allowed.'), false);
  }
};
